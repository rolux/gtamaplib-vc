...
EXTRA_FIXED_ELEVATION = [
    {
        ...
        "landmarks": [
            ...
            "Large Grassrivers Bridge (1)",
            "Large Grassrivers Bridge (2)",
            "Large Grassrivers Bridge (3)",
            "Light Pollution (A)",
            "Light Pollution (B)",
            "Light Pollution (C)",
            "Small Grassrivers Bridge (E)",
            "Small Grassrivers Bridge (W)",
...
def write_map3d_data(md: Any) -> None:
    ...
    names.update({"Four Seasons Hotel Miami", "Sunshine Skyway Bridge", "536 Richard Jackson Blvd", "Jason's House"})
    colors = {
