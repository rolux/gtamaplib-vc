...
BUILDINGS = [
    ...
    *[
    ...
    "1500 Sonora Ave",
    {"name": "1111 Lincoln Rd", "photo_kinds": ["ig", "rl"]},
    "Capri South Beach",
    ...
    {"name": "Turkey Point Nuclear Power Station (N)", "photo_id": "L256", "width": 50.0},
    {"name": "Turkey Point Nuclear Power Station (S)", "photo_id": "L879", "width": 50.0},
    {"name": "Turkey Point Nuclear Power Station (1)", "photo_id": "L880", "width": 5.0},
    {"name": "Turkey Point Nuclear Power Station (2)", "photo_id": "L881", "width": 5.0},
    {"name": "Turkey Point Nuclear Power Station (3)", "photo_id": "L882", "width": 5.0},
    "Central District Wastewater Treatment Plant",
    {"name": "419 NE 4th Ave", "photo_kinds": ["ig", "rl"]},
    "Hotel Victor",
    {"name": "Miami Beach Parking Garage", "width": 50.0},
    {"name": "City View Parking Garage", "width": 50.0},
    "Magic City Casino",
    "Jenny Hostel",
    "Springfield Community Church",
    {"name": "Star Island Water Tower", "photo_kinds": ["ig", "rl"], "width": 5.0},
    {"name": "Radio Tower (Ambrosia)", "photo_id": "L888", "width": 5.0},
    "Flamingo South Beach",
    {"name": "Cruise Terminal D", "photo_kinds": ["ig", "rl"]},
    "Hotel Breakwater",
